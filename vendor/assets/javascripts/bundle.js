...
/***/ function(module, exports, __webpack_require__) {
	...
	Vue.use(__webpack_require__(63));

	var EditApp = (function (_Vue) {
	    _inherits(EditApp, _Vue);

	    function EditApp(element) {
	        _classCallCheck(this, EditApp);
	        ...
	        var properties = {
	            ...
	            ready: function ready() {
	                var assignElement = $(this.$el).find('.js-assign-data');
	            ...
	            methods: {
	                sortMessage: function sortMessage(messages, loadMessages, index, droptag, dropdata) {
	                    switch (dropdata.type) {
	                        case 'message':
	                            var t = messages[index];
	                ...
	                insertMessage: function insertMessage(messages, loadMessages, index, droptag, dropdata) {
	                    var t = undefined;
	                    switch (dropdata.type) {
	                        case 'message':
	                ...
	                addMessage: function addMessage(messages, loadMessages, droptag, dropdata) {
	                    switch (dropdata.type) {
	                        case 'message':
	                            var t = messages[dropdata.index];
	                            messages.push(t);
	                            messages.splice(dropdata.index, 1);
	                            break;
	                        case 'loadMessage':
	                ...
	                dropMessage: function dropMessage(messages, droptag, dropdata) {
	                    if (dropdata.type != 'message') return;
	                    messages.splice(dropdata.index, 1);
	                },
	                onPermalink: function onPermalink(e, permalink, loadMessages) {
	                    e.preventDefault();
	                ...
	                onSubmit: function onSubmit(e, title, description, messages) {
	                    var messageIDs = messages.map(function (n) {
	                        return n.id;
	                    });
	                    e.preventDefault();
	                    ...
	                    _this.nowSubmitting = true;
	                    $.ajax({
	                        type: _this.summaryID ? 'put' : 'post',
	                        url: _this.summaryID ? '/summaries/' + _this.summaryID + '.json' : '/summaries.json',
	                        data: {
	        ...
	        _get(Object.getPrototypeOf(EditApp.prototype), 'constructor', this).call(this, properties);
	...
	var createEditApp = function createEditApp(element) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.compiler = {
	  compile: __webpack_require__(11),
	  transclude: __webpack_require__(16)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.transition = __webpack_require__(34);
	...
	exports['with'] = __webpack_require__(49);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var handlers = {
	  _default: __webpack_require__(37),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var expParser = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var templateParser = __webpack_require__(15);
	var compile = __webpack_require__(11);
	var transclude = __webpack_require__(16);
	var mergeOptions = __webpack_require__(10);
	var uid = 0;
