	    ...
	    function EditApp(element) {
	        ...
	        var properties = {
	            ...
	            ready: function ready() {
	                _this2.summaryID = $(_this2.$el).data('summary-id');
	                _this2.title = $(_this2.$el).find('.js-edit-app-title').val();
	                _this2.description = $(_this2.$el).find('.js-edit-app-description').val();
	                _this2.messages = $(_this2.$el).data('messages');
	            },
	            methods: {
	                ...
	                insertMessage: function insertMessage(messages, loadMessages, index, droptag, dropdata) {
	                    switch (dropdata.type) {
	                        ...
	                        case 'loadMessage':
	                            ...
	                            var t = loadMessages[dropdata.index];
	                            loadMessages.splice(dropdata.index, 1);
	                            messages.splice(index, 0, t);
	                            break;
	                    }
	                ...
	                onSubmit: function onSubmit(e, title, description, messages) {
	                    ...
	                    _this2.nowSubmitting = true;
	                    $.ajax({
	                        type: _this2.summaryID ? 'put' : 'post',
	                        url: _this2.summaryID ? '/summaries/' + _this2.summaryID + '.json' : '/summaries.json',
	                        data: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(13);
	var applyCSSTransition = __webpack_require__(55);
	var applyJSTransition = __webpack_require__(56);
